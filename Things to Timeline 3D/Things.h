 ...
 * Things.h
 *
 * This file was generated with the Terminal command:
 * sdef /Applications/Things.app | sdp -fh --basename Things
 *
 * See "Scripting Bridge Programming Guide" for more info
 */
